...
function we({
  ...
  const { styleHeight: f, styleWidth: a } = (0, import_react.useMemo)(
    () => ({
      styleHeight: ce(l == null ? void 0 : l.height),
      styleWidth: ce(l == null ? void 0 : l.width)
    }),
    [l == null ? void 0 : l.height, l == null ? void 0 : l.width]
  ), [o, d] = (0, import_react.useState)({
    height: t,
    width: s
  ...
  return J(() => {
    ...
    return g.observe(n, { box: e }), () => {
      g == null ? void 0 : g.unobserve(n);
    };
  }, [e, c, n, f, a]), (0, import_react.useMemo)(
    () => ({
      height: f ?? o.height,
      width: a ?? o.width
    }),
...
function Ve({
  ...
  const E = he(t), D = (0, import_react.useMemo)(
    () => (0, import_react.memo)(e, pe),
    [e]
  ), [v, U] = (0, import_react.useState)(null), m = Ie(v, o), {
    getCellBounds: G,
    getEstimatedSize: p,
  ...
  (0, import_react.useImperativeHandle)(
    ...
    () => ({
      ...
      scrollToCell({
        ...
        const q = S({
          align: y,
          containerScrollOffset: (v == null ? void 0 : v.scrollLeft) ?? 0,
          index: H
        }), ve = K({
          align: W,
        ...
        typeof (v == null ? void 0 : v.scrollTo) == "function" && v.scrollTo({
          behavior: $,
          left: q,
          top: ve
        });
...
function Le({
  ...
  const h = he(c), z = (0, import_react.useMemo)(
    () => (0, import_react.memo)(f, pe),
    [f]
  ), [u, j] = (0, import_react.useState)(null), T = Te(o), E = (0, import_react.useMemo)(() => T ? (b) => o.getRowHeight(b) ?? o.getAverageRowHeight() : o, [T, o]), {
    getCellBounds: D,
    getEstimatedSize: v,
    scrollToIndex: U,
  ...
  (0, import_react.useImperativeHandle)(
    ...
    () => ({
      ...
      scrollToRow({
        ...
        const _ = U({
          align: b,
          containerScrollOffset: (u == null ? void 0 : u.scrollTop) ?? 0,
          index: V
        });
        typeof (u == null ? void 0 : u.scrollTo) == "function" && u.scrollTo({
          behavior: w,
          top: _
        });
      }
...
function Me({
  ...
  const { map: n } = s, i = (0, import_react.useCallback)(() => {
    let c = 0;
    return n.forEach((g) => {
      c += g;
    }), c === 0 ? e : c / n.size;
  }, [e, n]), l = (0, import_react.useCallback)(
    (c) => {
      const g = n.get(c);
      return g !== void 0 ? g : (n.set(c, e), e);
    },
    [e, n]
  ), f = (0, import_react.useCallback)((c, g) => {
    r((x) => {
      if (x.map.get(c) === g)
        return x;
...
var $e = import_react.useState;
var He = import_react.useRef;
var te = -1;
function We(e = false) {
  if (te === -1 || e) {
    const t = document.createElement("div"), s = t.style;
